...
const Login = () => {
    return (
        <div className='w-full mx-auto'>
          <div className="my-5 w-full mx-auto max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-50 dark:text-gray-800">
	...
	<form noValidate="" action="" className="space-y-6">
		...
		<button className="block w-full p-3 text-center rounded-sm dark:text-gray-50 bg-indigo-700">Sign in</button>
	</form>
